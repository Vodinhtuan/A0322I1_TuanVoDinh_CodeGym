...
public class TaiKhoanTietKiem extends TaiKhoanNganHang{
    ...
    public TaiKhoanTietKiem(int idTaiKhoan, String maTaiKhoan, String tenChuTaiKhoan, String ngayTaoTaiKhoan, double soTienGui, String ngayGui, double laiSuat, int kiHan) {
