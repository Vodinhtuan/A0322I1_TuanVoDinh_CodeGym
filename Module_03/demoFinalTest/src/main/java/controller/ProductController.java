...
public class ProductController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "update":
                ...
                request.getRequestDispatcher("/exam/product/update.jsp").forward(request, response);
                break;
            case "delete":
                try {
    ...
    private void createNewProduct(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (error == null) {
            try {
                service.create(new Product(name,price,quantity,color,description,cateStr));
            } catch (Exception e) {
                error = e.getMessage();
            }
        }
    ...
    private void updateProduct(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        if (error == null) {
            try {
                service.update(new Product(id,name,price,quantity,color,description,cateStr));
            } catch (Exception e) {
                error = e.getMessage();
            }
        }
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/exam/product/update.jsp");
