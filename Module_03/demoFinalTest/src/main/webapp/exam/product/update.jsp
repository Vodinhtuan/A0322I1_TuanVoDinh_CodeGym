                        ...
                        <div class="body">
                            <form action="/product?action=update" method="post">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="name" class="form-control" value="${product.name}" placeholder="Product Name" tabindex="3" id="name" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="price" class="form-control" value="${product.price}" placeholder="Price" tabindex="4" id="price" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="quantity" class="form-control" value="${product.quantity}" placeholder="Quantity" tabindex="5" id="quantity" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="description" class="form-control" value="${product.description}" placeholder="Description" tabindex="1" autofocus="autofocus" id="description" />
                                    </div>
                                </div>
