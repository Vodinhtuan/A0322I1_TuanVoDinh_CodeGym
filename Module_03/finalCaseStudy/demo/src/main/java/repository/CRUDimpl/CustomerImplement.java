...
public class CustomerImplement implements CustomerRepository {
    ...
    public void create(Customer customer) throws Exception {
        ...
        try (
                ...
                PreparedStatement statement = connection.prepareStatement(CustomerConstants.INSERT_INTO_CUSTOMER);
        ) {
    ...
    public void update(Customer customer) throws Exception {
        ...
        try (
                Connection connection = ConnectionUtils.getConnection();
                PreparedStatement statement = connection.prepareStatement(CustomerConstants.UPDATE_CUSTOMER);
        ) {
    ...
    public boolean deleteById(int id) throws Exception {
        boolean rowDeleted;
        try (Connection connection = ConnectionUtils.getConnection(); PreparedStatement statement = connection.prepareStatement(CustomerConstants.DELETE_BY_ID);) {
    ...
    public Customer findById(int id) throws SQLException, ClassNotFoundException {
        try(
                Connection connection = ConnectionUtils.getConnection();
                PreparedStatement statement = connection.prepareStatement(CustomerConstants.FIND_CUSTOMER_BY_ID);
                ){
            statement.setInt(1, id);
            ...
            if (rs.next()){
                ...
                return new Customer(id,name,birthday,gender,idCard,phone,email,type_id,address);
            }
        }
        return null;
    }
    ...
    public List<Customer> findAll() throws SQLException, ClassNotFoundException {
        ...
        try(Connection connection = ConnectionUtils.getConnection();
            ...
            ResultSet rs = statement.executeQuery(CustomerConstants.SELECT_ALL_FROM_CUSTOMER);){
            while (rs.next()){
                ...
                String email = rs.getString("customer_email");
                String address = rs.getString("customer_address");
                customers.add(new Customer(id,name,birthday,gender,idCard,phone,email,type_id,address));
            }
        }
        return customers;
    }
