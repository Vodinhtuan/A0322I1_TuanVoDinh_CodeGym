            ...
            <ul class="nav navbar-nav" style="margin-left: 270px">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${contextPath}/product?action=list">List Employee</a></li>
                        <li><a href="${contextPath}/product?action=create">Create Employee</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false">Customer
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="${contextPath}/product?action=list">List Customer</a></li>
                        <li><a href="${contextPath}/product?action=create">Create Customer</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false">Service
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="${contextPath}/product?action=list">List </a></li>
                        <li><a href="${contextPath}/product?action=create">Create </a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
